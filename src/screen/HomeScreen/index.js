      ...
      <div class="content">
        <div id="large-header" class="large-header">
          <div class="container-box">
            ...
            <span class="text-dev">
              Coding three years and making dream come true with React & React
              Native
            </span>
            ...
            <div className="container-social-media">
              <a href="https://github.com/lfoliveir4" target="_blank">
                <img src={github} className="icon-social-media" />
              </a>
              <a href="https://gitlab.com/lfoliveira.dev" target="_blank">
                <img src={gitlab} className="icon-social-media" />
              </a>
              <a
                href="https://www.linkedin.com/in/lf-oliveira/"
                target="_blank"
              >
                <img src={linkedin} className="icon-social-media" />
              </a>
              <a href="https://twitter.com/lfoliveir4" target="_blank">
                <img src={twitter} className="icon-social-media" />
              </a>
            </div>
            <span class="small-text">
              <a href={`mailto:lfoliveira.dev@gmail.com`}>
                lfoliveira.dev@gmail.com
              </a>
            </span>
